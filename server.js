...
Use the supplied image as the character
identity reference.

Preserve the character's appearance,
colors, clothing, shape, facial features,
proportions, materials and distinctive details.
...
REFERENCE IMAGE 1 = CHARACTER 1.
REFERENCE IMAGE 2 = CHARACTER 2.

Use both images as visual character references
for the SAME generated 10-second scene.

These are character references.
...
Choose the best cinematic camera
movement for the story.
...
If dialogue is included, characters should
naturally speak with suitable facial reactions
and matching mouth movement.
...
```
    ...
    console.log(
        "Reference mode: Image Reference"
    );
