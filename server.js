...
function getRatio(
    ...
    if (
         ...
         * supports square output.
         *
         * Text-to-Video does not use
         * 1:1 in the current API schema.
         */
...
function getDuration(
    ...
    /*
     * The frontend uses 5 or 10 seconds.
     * Keep the backend compatible with
     * the selected UI values.
     */
...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            /*
             * Runway accepts data:image/*
             * values up to 5,242,880 characters.
             *
             * This check is based on the encoded
             * Data URI length, not the original
             * file size.
             */
            ...
            for (
                ...
                if (
                    ...
                    return res.status(400).json({
                        ...
                        error:
                            "Reference image is too large. Please use a smaller image."
            ...
            if (!ratio) {
                ...
                return res.status(400).json({
                    ...
                    error:
                        "Square 1:1 video requires at least one character reference image."
