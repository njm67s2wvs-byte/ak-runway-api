    ...
    async (req, res) => {
        ...
        try {
            ...
            if (
                 ...
                 * IMPORTANT:
                 *
                 * Runway's current text-to-video
                 * schema accepts 2-10 seconds.
                 *
                 * getDuration() allows Seedance 2
                 * up to 15 seconds, but the frontend
                 * currently sends only 5 or 10 seconds.
                 */
                 ...
                 * 1:1 or other image-only ratios.
                 *
                 * The frontend only exposes
                 * 9:16, 16:9 and 1:1.
                 *
                 * For text-only 1:1, use
                 * the supported square ratio.
                 */
